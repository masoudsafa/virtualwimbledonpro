...
/////////////////////////////////////////////////////////////////////////////////////////      
		...
		LOG(" In Render [%f %f %f ]",ballTransform.data[0], ballTransform.data[1], ballTransform.data[2]);
...
//
//	
//   SampleUtils::translatePoseMatrix(35.0f, 10.0f, float(someNumber),
//    										 transform);
//
...
//	}
	...
	if (rotateBowlAngle == 180.0f * 180.0f/3.1415f)
	        dt*=direction;
	
	SampleUtils::translatePoseMatrix(++rotateBowlAngle, 0.0f, 20.0f, 0.0f,transform);
		prevTime = time;						  
...
//	
//	
//    SampleUtils::rotatePoseMatrix(rotateBowlAngle, 0.0f, 20.0f, 0.0f,
//                                  transform);
//	
//    prevTime = time;
